...
### Stage 1: Pre-training (Not RLHF)
Train on massive text corpus to learn language patterns:
- Trillions of tokens from the internet, books, code, etc.
- Learns grammar, facts, reasoning patterns, everything
- Objective: Predict the next token
- Result: A capable but unaligned "text completer"

### Stage 2: Supervised Fine-Tuning (SFT)
Train on demonstrations of helpful behavior:
- Human-written examples of good assistant responses
- High-quality prompt-response pairs
- Objective: Imitate the demonstrations
- Result: Assistant-like behavior, but limited

### Stage 3: RLHF
Reinforce good behavior through human preferences:
- Humans rank model outputs
- Train a reward model on these preferences
- RL optimizes the model toward higher rewards
- Result: Refined, human-aligned assistant
