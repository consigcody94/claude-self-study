...
### Sparse Autoencoders
Learn interpretable features from activations:
1. Train autoencoder with sparsity constraint
2. Learned features often interpretable
3. Helps address superposition

This reveals hidden features.
